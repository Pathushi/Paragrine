...
export const adminAPI = {
  ...
  pullPlaybooks: (id) => api.post(`/controllers/${id}/pull_playbooks/`), // Added
  getCachedPlaybooks: (id) => api.get(`/playbook-cache/?controller_id=${id}`), // Added
...
export const userAPI = {
  ...
  runTask: (assignmentId, data) => {
    ...
    // Explicitly send user_id in the body
